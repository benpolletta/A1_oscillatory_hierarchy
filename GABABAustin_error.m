function varargout = GABABAustin_error(cluster_flag, compile_flag)
...
i=1;
    ...
    sim_spec.connections(i).mechanism_list = {'iGABABAustin'};
...
Now = clock;
name = sprintf('GABABAustin_error_%s_%g_%g_%.4g', Today, Now(4), Now(5), Now(6));
