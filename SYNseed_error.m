function varargout = SYNseed_error(cluster_flag, compile_flag)
...
i=1;
    ...
    sim_spec.connections(i).parameters = {'g_SYN',0.8,'E_SYN',-95,...
        'tauRx',150,'tauDx',38,... 'gGABAB_hetero',gsyn_hetero, ...
        };
