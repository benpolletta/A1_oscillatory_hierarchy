...
if include_deepRS
    ...
    spec.populations(i).parameters = {...
      'Cm',Cm_RS,'PPstim',deepRSPPstim,'gSpike',deepRSgSpike,'PPcenter',0,'PPnorm',0,...
      'gKs',Cm_factor*0.134,'gKCs',0,'gNaP',gKs/gNaP_denom,'gKCa',Cm_factor*0.014,'bKCa',.002,'gCa',Cm_factor*0.05,'CAF',CAF,...
      'gl',gl_dRS,'gNa',gNa_dRS,'gKDR',gKDR_dRS,...
      'I_const',I_const,'tau_h',tau_fast,'tau_m',tau_fast,... 
      'ton',500,'toff',tspan(end),'I_app',-9.8,'Inoise',0,...                                         %  (ton<t&t<toff) %%% 'PPstim = 0; PPfreq = 1.5; PPwidth = floor((1000/PPfreq)/4); PPshift = 0; ap_pulse_num = 0; kernel_type = 7;',... % in ms
