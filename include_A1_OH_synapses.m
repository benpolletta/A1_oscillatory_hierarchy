...
if include_RS
    ...
    spec.connections(i).parameters = {'g_SYN',gAMPA_rsrs,'E_SYN',EAMPA,...
        'tauDx',tauAMPAd,'tauRx',tauAMPAr,'fanout',inf,'IC_noise',0,...
        'g_SYN_hetero',gsyn_hetero, 'g_GAP',ggjaRS,...
        };
end
...
if include_RS && include_FS
    ...
    spec.connections(i).parameters = {'g_SYN',gAMPA_rsfs,'E_SYN',EAMPA,...
        'tauDx',tauAMPAd,'tauRx',tauAMPAr,'fanout',inf,'IC_noise',0,...
        'g_SYN_hetero',gsyn_hetero, ...
        };
end
...
if include_RS && include_LTS
    ...
    spec.connections(i).mechanism_list = {'IBaIBdbiSYNseed'};
    spec.connections(i).parameters = {'g_SYN',gAMPA_rsLTS,'E_SYN',EAMPA,...
        'tauDx',tauAMPAd,'tauRx',tauAMPAr,'fanout',inf,'IC_noise',0,...
        'g_SYN_hetero',gsyn_hetero, ...
        };
end
